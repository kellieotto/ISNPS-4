...
\abstract{
1) Pigeonhole principle shows that PRNGs cannot be adequate
2) Some sampling algorithms are better than others: ones that use only $k$ PRNs to sample are better than those that use $n$ when $k \ll n$
3) Common software has these issues.
}
