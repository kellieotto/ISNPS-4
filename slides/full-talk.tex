...
\begin{center}
\begin{tikzpicture}
  \node (img1) {\includegraphics[height=0.8\paperheight]{fig/jupyter_notebook.png}};
  \node (img2) at (img1.east)[xshift=-1cm,yshift=-1.5cm] {\includegraphics[height=0.15\paperheight]{fig/binder.png}};
\end{tikzpicture}
\end{center}
